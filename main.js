...
function getPairs() {
    ...
    for (let i = 0; i < studentsGirl.length; i++) {
        result.push([studentsGirl[i],studentsBoy[i]]);
    }
    return result;
}
...
function pairsAndThemes() {
    let result = [];
    for (let i = 0; i < studentsGirl.length; i++) {
        result.push([studentsGirl[i] + " и " + studentsBoy[i], themes[i]]);
    }
    return result;
}
...
function studentsThemesAndMarks () {
    let result = [];
    for (let i = 0; i <studentsGirl.length ; i++) {
        result.push([studentsGirl[i] + " и " + studentsBoy[i], themes[i], Math.floor(Math.random()*5+1)]);
    }
    return result;
}
